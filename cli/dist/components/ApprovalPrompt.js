...
export const ApprovalPrompt = ({ request, commandToApprove, reason, repoName, branch, onRespond }) => {
    ...
    return (_jsxs(Box, { flexDirection: "column", borderStyle: "round", borderColor: "yellow", paddingX: 2, paddingY: 1, margin: 1, children: [_jsx(Box, { justifyContent: "center", marginBottom: 1, children: _jsx(Text, { color: "yellow", bold: true, children: "\uD83D\uDC51 ROYAL HARNESS \u2014 GITHUB CODE PUSH APPROVAL" }) }), _jsxs(Box, { flexDirection: "column", borderStyle: "single", borderColor: "magenta", paddingX: 1, marginY: 1, children: [_jsxs(Box, { gap: 2, children: [_jsx(Text, { color: "yellow", bold: true, children: "Repository :" }), _jsx(Text, { color: "white", bold: true, children: targetRepo })] }), _jsxs(Box, { gap: 2, children: [_jsx(Text, { color: "yellow", bold: true, children: "Branch     :" }), _jsx(Text, { color: "cyan", children: targetBranch })] }), _jsxs(Box, { gap: 2, children: [_jsx(Text, { color: "yellow", bold: true, children: "Command    :" }), _jsx(Text, { color: "green", bold: true, children: targetCommand })] }), _jsxs(Box, { gap: 2, children: [_jsx(Text, { color: "yellow", bold: true, children: "Reason     :" }), _jsx(Text, { color: "white", children: targetReason })] })] }), _jsxs(Box, { marginY: 1, children: [_jsx(Text, { color: "yellow", bold: true, children: "\uD83D\uDEE1\uFE0F  SECURITY NOTICE:" }), _jsxs(Text, { color: "gray", children: [' ', "This action will write local codebase modifications directly to GitHub."] })] }), _jsxs(Box, { marginTop: 1, gap: 1, alignItems: "center", children: [_jsx(Text, { color: "white", bold: true, children: "Push code to GitHub? [" }), _jsx(Text, { color: "green", bold: true, underline: true, children: "y" }), _jsx(Text, { color: "white", children: "/" }), _jsx(Text, { color: "red", bold: true, underline: true, children: "N" }), _jsx(Text, { color: "white", bold: true, children: "]:" })] }), _jsx(Box, { marginTop: 1, children: _jsx(Text, { color: "gray", dimColor: true, children: "Press 'y' to confirm & push to GitHub | Press 'n' or Esc to cancel execution (Default: Deny)" }) })] }));
};
